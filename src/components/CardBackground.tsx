...
export const CardBackground = memo(function CardBackground({
      ...
      canvas => {
        ...
        if (shouldRenderTop) {
          ...
          canvas.drawImageRect(
            ...
            { x: 0, y: 0, width: CARD_CORNER_ORIGINAL_SIZE, height: CARD_CORNER_ORIGINAL_SIZE },
            { x: w - roundedCornerSize, y: 0, width: roundedCornerSize, height: roundedCornerSize },
            paint
          )
        }
  ...
  }, [cachedImages, tint, width, height, cornerSize, w, h, sideLineHeight])
